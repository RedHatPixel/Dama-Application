...
import com.dama.gameGui.game_panel.BoardPanel;
import com.dama.gameGui.game_panel.DragGlassPane;
import com.dama.gameGui.game_panel.Table;
import com.dama.gameGui.game_panel.TilePanel;
import java.awt.*;
...
public final class TilePanelSystem implements MouseListener {
    ...
    private void validateMove() {
        ...
        else if (Board.calculate50LatestMove(getTable().getGamePlay()).isEmpty()) {
