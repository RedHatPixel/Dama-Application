...
public class PlayerSetting extends CardPanelRegistry {
    ...
    public void setGameInformation() {
        if (CardPanelRegistry.isInstanced(GamePlay.class)) {
            final TablePanel tablePanel = CardPanelRegistry.getInstance(GamePlay.class).getTable();
            final GameInfo gameInformation = tablePanel.getGameInfo();
            title.setText(gameInformation.getPlayerName() + " vs " + gameInformation.getOpponentName());
            playerOneName.setText(gameInformation.getPlayerName());
            playerTwoName.setText(gameInformation.getOpponentName());
            setScoreInformation();
            updateGameRecords();
        }
    }
    
    public void setScoreInformation() {
        if (CardPanelRegistry.isInstanced(GamePlay.class)) {
            final TablePanel tablePanel = CardPanelRegistry.getInstance(GamePlay.class).getTable();
            playerOneScore.setText(Integer.toString(tablePanel.getPlayerPanel().getPlayerInfo().getScore()));
            playerTwoScore.setText(Integer.toString(tablePanel.getOpponentPanel().getPlayerInfo().getScore()));
        }
    }
    ...
    public boolean quitConfirmation() {
        ...
        if (status == QuitConfirmation.RET_YES) {
            createNewUnplayableTable();
            return true;
        }
        return false;
    }
    
    public void createNewUnplayableTable() {
        if (CardPanelRegistry.isInstanced(GamePlay.class)) {
            CardPanelRegistry.getInstance(GamePlay.class).setUnPlayableTable();
    ...
    private void initComponents() {
        ...
        moveRecords = new com.dama.gui.controlPanel.MoveRecords();
        app.buttons.MainButton restartButton = new app.buttons.MainButton();
        app.buttons.MainButton undoButton = new app.buttons.MainButton();
        app.buttons.MainButton backButton = new app.buttons.MainButton();
        app.buttons.MainButton forwardButton = new app.buttons.MainButton();
        app.buttons.MainButton surrenderButton = new app.buttons.MainButton();
        app.buttons.MainButton quitButton = new app.buttons.MainButton();
    ...
    private void restartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restartButtonActionPerformed
        ...
        if (status == QuitConfirmation.RET_YES) {
            if (CardPanelRegistry.isInstanced(GamePlay.class)) {
                ...
                CardPanelRegistry.getInstance(GamePlay.class).makeNewTable(
                        GameBuilder.createRestaredTablePanel(table));
                setGameInformation();
            }
        }
    ...
    private com.dama.gui.controlPanel.MoveRecords moveRecords;
