...
import com.dama.gui._controls.TilePanelSystem;
...
public final class TilePanel extends JPanel {
    ...
    private void initComponent() {
        ...
        // WARNING: Remove Button Functionality -> TablePanel == null
        if (table != null)  {
    ...
    private void highlightMovablePiece(final Board board) {
        if (!table.getGameSetting().canShowMovablePiece()) return;
    ...
    private void highlightTileFinalMove(final Board board) {
        if (board.getLatestMove() == null || !table.getGameSetting().canShowLatestMove()) return;
    ...
    private void highlightTileBackgroundCaptures(final Piece piece, final Board board) {
        if (piece == null || !table.getGameSetting().canShowCaptures()) return;
    ...
    private void assignTileSelectionIcon(final Piece piece, final Board board) {
        if (piece == null || !table.getGameSetting().canShowValidMoves()) return;
