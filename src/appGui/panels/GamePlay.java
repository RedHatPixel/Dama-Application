...
public class GamePlay extends CardPanelRegistry {
    ...
    private void initComponents() {
        ...
        navigator = new appGui.panels.mainSubPanel.Navigator();
        mainBody = new javax.swing.JPanel();
        tableContainer = new javax.swing.JPanel();
        table = new com.dama.gameGui.game_panel.Table();
        javax.swing.JPanel settingBG = new javax.swing.JPanel();
        appGui.panels.controlPanel.SettingContainer settingContainer = new appGui.panels.controlPanel.SettingContainer();
        appGui.panels.controlPanel.MultiplayerSetting multiplayerSetting = new appGui.panels.controlPanel.MultiplayerSetting();
        appGui.panels.controlPanel.PlayerSetting playerSetting = new appGui.panels.controlPanel.PlayerSetting();
    ...
    private appGui.panels.mainSubPanel.Navigator navigator;
    private com.dama.gameGui.game_panel.Table table;
