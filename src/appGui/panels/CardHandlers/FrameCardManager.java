package appGui.panels.CardHandlers;
...
public abstract class FrameCardManager extends JFrame implements CardLayoutManager {
    private final Map<CardPanelRegistry, String> cardPanels = new HashMap<>();
    
    protected FrameCardManager() {
    ...
    public void showPanel(final CardPanelRegistry panelClass) {
        ...
        card.show(this.getContentPane(), name);
    }
