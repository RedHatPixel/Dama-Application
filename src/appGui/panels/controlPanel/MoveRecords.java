...
public class MoveRecords extends JPanel {
    ...
    public void updateGameRecord() {
        ...
        if (CardPanelRegistry.isInstanced(GamePlay.class)) {
            ...
            final List<Board> gamePlay = table.getGamePlay();
            
            for (final Board board : gamePlay) {
    ...
    private void initComponents() {
        ...
        mainScrollPane = new appGui.scrollPanes.MainScrollPane();
    ...
    private appGui.scrollPanes.MainScrollPane mainScrollPane;
