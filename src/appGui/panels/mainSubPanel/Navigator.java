package appGui.panels.mainSubPanel;
...
public class Navigator extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        playButton = new appGui.buttons.NavButton();
        learnButton = new appGui.buttons.NavButton();
        aboutButton = new appGui.buttons.NavButton();
        settingsButton = new appGui.buttons.NavButton();
        quitButton = new appGui.buttons.NavButton();
    ...
    private appGui.buttons.NavButton aboutButton;
    private appGui.buttons.NavButton learnButton;
    private appGui.buttons.NavButton playButton;
    private appGui.buttons.NavButton quitButton;
    private appGui.buttons.NavButton settingsButton;
