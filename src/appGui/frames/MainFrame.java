...
public class MainFrame extends FrameCardManager {
    ...
    private void initComponents() {
        ...
        mainMenu = new appGui.panels.MainMenu();
        appGui.panels.GamePlay gamePlay = new appGui.panels.GamePlay();
        appGui.panels.Tutorial tutorial = new appGui.panels.Tutorial();
        about = new appGui.panels.About();
    ...
    private appGui.panels.About about;
    private appGui.panels.MainMenu mainMenu;
