...
public class OkConfirmation extends JDialog {
    ...
    public OkConfirmation(final String message, final String title, final Frame parent, final boolean modal) {
        super(parent, true);
    ...
    public OkConfirmation(final String message, final String title, final Frame parent) {
