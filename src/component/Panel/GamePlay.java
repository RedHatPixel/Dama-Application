...
public class GamePlay extends javax.swing.JPanel implements Direction {
    ...
    public GamePlay() {
        ...
        title.setFont(FontManager.getFont(FontName.POPPINS_BLACK, FontType.POPPINS, title.getFont().getSize()));
        for (final Component comp : content.getComponents()) {
            if (comp instanceof javax.swing.JLabel) {
                ...
                jLabel.setFont(FontManager.getFont(
                        FontName.POPPINS_BLACK, FontType.POPPINS, jLabel.getFont().getSize()));
            }
                ...
                jRadioButton.setFont(FontManager.getFont(
                        FontName.POPPINS_BOLD, FontType.POPPINS, jRadioButton.getFont().getSize()));
            }
                ...
                jTextField.setFont(FontManager.getFont(
                        FontName.POPPINS_MEDIUM, FontType.POPPINS, jTextField.getFont().getSize()));
            }
                ...
                jCheckBox.setFont(FontManager.getFont(
                        FontName.POPPINS_SEMIBOLD, FontType.POPPINS, jCheckBox.getFont().getSize()));
            }
        }
    ...
    private void initComponents() {
        ...
        controlSystem = new javax.swing.JPanel();
        ...
        resetButton = new component.Button.MainButton();
        ...
        controlSystem.setFocusable(false);
        controlSystem.setMinimumSize(new java.awt.Dimension(350, 10));
        controlSystem.setOpaque(false);
        controlSystem.setPreferredSize(new java.awt.Dimension(350, 10));
        controlSystem.setLayout(new java.awt.CardLayout());

        multiplayerPanel.setOpaque(false);
        multiplayerPanel.setLayout(new java.awt.GridBagLayout());

        container.setBackground(new java.awt.Color(38, 37, 34));
        container.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 5, 5, 0, new java.awt.Color(29, 28, 26)));
        ...
        playerLabelTwo.setLabelFor(playerTwoName);
        ...
        playerLabelOne.setLabelFor(playerOneName);
        ...
        whiteRadio.setBackground(new java.awt.Color(29, 28, 26));
        ...
        randomRadio.setBackground(new java.awt.Color(29, 28, 26));
        ...
        randomRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/game_icon/WhiteSelection.png"))); // NOI18N
        ...
        blackRadio.setBackground(new java.awt.Color(29, 28, 26));
        ...
        noTimerRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/game_icon/handshake.png"))); // NOI18N
        ...
        container.add(scrollableContent, gridBagConstraints);
        ...
        container.add(resetButton, gridBagConstraints);
        ...
        container.add(startButton, gridBagConstraints);
        ...
        multiplayerPanel.add(container, gridBagConstraints);

        controlSystem.add(multiplayerPanel, "Multiplayer");

        mainBody.add(controlSystem, java.awt.BorderLayout.EAST);
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startButtonActionPerformed
        ...
        switch (selectedDuration) {
            ...
            default ->
                GameInfo.setGameDuration(GameInfo.GameDuration.NULL);
        }
    ...
    private javax.swing.JPanel controlSystem;
